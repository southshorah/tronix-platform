...
import org.tron.common.vm.program.Stack;
...
import static org.tron.common.vm.OpCode.*;
...
public class VM {
    ...
    private boolean isDeadAccount(Program program, byte[] addr) {
        //return !program.getStorage().isExist(addr) || program.getStorage().getAccountCapsule(addr).isEmpty();
    ...
    public void step(Program program) {
        ...
        try {
            ...
            GasCost gasCosts = tronConfig.getGasCost();
            ...
            switch (op) {
                ...
                case STATICCALL:
                    ...
                    adjustedCallGas = new DataWord(tronConfig.getGasCost().getCALL());
