...
import org.tron.common.vm.*;
import org.tron.common.vm.PrecompiledContracts.PrecompiledContract;
...
import org.tron.common.vm.program.listener.CompositeProgramListener;
import org.tron.common.vm.program.listener.ProgramListenerAware;
import org.tron.common.vm.program.listener.ProgramStorageChangeListener;
import org.tron.common.vm.trace.ProgramTrace;
import org.tron.common.vm.trace.ProgramTraceListener;
import org.tron.core.config.blockchain.TronConfig;
...
public class Program {
    ...
    public Program(byte[] codeHash, byte[] ops, ProgramInvoke programInvoke, InternalTransaction transaction, SystemProperties config) {
        ...
        this.tronConfig = config.getTronConfig();
    }
    ...
    public void createContract(DataWord value, DataWord memStart, DataWord memSize) {
        ...
        AccountCapsule existingAddr = getStorage().getAccountCapsule(newAddress);
        ...
        */
        ...
        long oldBalance = track.getBalance(newAddress);
        track.createAccount(newAddress, Protocol.AccountType.Contract);
        ...
        } else if (getLength(code) > tronConfig.getConstants().getMAX_CONTRACT_SZIE()) {
    ...
    public void callToAddress(MessageCall msg) {
        ...
        long senderBalance = track.getBalance(senderAddress);
    ...
    */
    ...
    public TronConfig getBlockchainConfig() {
        return tronConfig;
    }
    ...
    public void callToPrecompiledAddress(MessageCall msg, PrecompiledContract contract) {
        ...
        transfer(track, senderAddress, contextAddress, msg.getEndowment().value().longValue());
